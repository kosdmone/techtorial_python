...
# We have to consider that user doesn't know about index number and the number user provided will be
# 1 bigger than the index number
# "Python"
#  012345   -> index number
#  123456   -> order number which user will be think it is true
